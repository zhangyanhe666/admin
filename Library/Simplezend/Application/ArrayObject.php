...
if (version_compare(PHP_VERSION, '5.3.4', 'lt')) {
    class_alias('Library\Application\ArrayObject\PhpLegacyCompatibility', 'Library\Application\AbstractArrayObject');
} else {
    class_alias('Library\Application\ArrayObject\PhpReferenceCompatibility', 'Library\Application\AbstractArrayObject');
}
