...
use Library\Db\RowGateway\RowGateway;
use Library\Db\RowGateway\RowGatewayInterface;
use Library\Db\TableGateway\Exception;
    ...
    public function postInitialize()
    {
        ...
        if (!$this->tableGateway->resultSetPrototype instanceof ResultSet) {
            throw new Exception\RuntimeException(
                'This feature ' . __CLASS__ . ' expects the ResultSet to be an instance of Library\Db\ResultSet\ResultSet'
            );
        }
        ...
        if (isset($args[0])) {
            ...
            $metadata = $this->tableGateway->featureSet->getFeatureByClassName('Library\Db\TableGateway\Feature\MetadataFeature');
