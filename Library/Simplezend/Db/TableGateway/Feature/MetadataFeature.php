...
use Library\Db\Metadata\Metadata;
use Library\Db\Metadata\MetadataInterface;
use Library\Db\TableGateway\Exception;
use Library\Db\Metadata\Object\TableObject;
...
class MetadataFeature extends AbstractFeature
{
    ...
    public function postInitialize()
    {
        ...
        foreach ($m->getConstraints($t->table) as $constraint) {
            /** @var $constraint \Library\Db\Metadata\Object\ConstraintObject */
