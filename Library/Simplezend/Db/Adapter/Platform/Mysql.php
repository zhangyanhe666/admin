...
namespace Library\Db\Adapter\Platform;

use Library\Db\Adapter\Driver\DriverInterface;
use Library\Db\Adapter\Driver\Mysqli;
use Library\Db\Adapter\Driver\Pdo;
use Library\Db\Adapter\Exception;
...
class Mysql implements PlatformInterface
{
    ...
    /**
     * @param \Library\Db\Adapter\Driver\Mysqli\Mysqli|\Library\Db\Adapter\Driver\Pdo\Pdo||\mysqli|\PDO $driver
     * @throws \Library\Db\Adapter\Exception\InvalidArgumentException
     * @return $this
     */
    public function setDriver($driver)
    {
        // handle Library\Db drivers
        ...
        throw new Exception\InvalidArgumentException('$driver must be a Mysqli or Mysql PDO Library\Db\Adapter\Driver, Mysqli instance or MySQL PDO instance');
    }
