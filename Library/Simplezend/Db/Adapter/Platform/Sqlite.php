...
class Sqlite implements PlatformInterface
{
    ...
    /**
     * @param \Library\Db\Adapter\Driver\Pdo\Pdo||\PDO $driver
    ...
    public function setDriver($driver)
    {
        ...
        throw new Exception\InvalidArgumentException('$driver must be a Sqlite PDO Library\Db\Adapter\Driver, Sqlite PDO instance');
    }
