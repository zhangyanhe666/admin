...
namespace Library\Db\RowGateway\Feature;

use Library\Db\RowGateway\AbstractRowGateway;
use Library\Db\RowGateway\Exception;
...
abstract class AbstractFeature extends AbstractRowGateway
{
    ...
    /**
     * @throws \Library\Db\RowGateway\Exception\RuntimeException
     */
